...
echo "==> Optional geo/codec deps (best-effort; only needed for multispectral + JPEG2000 baseline)"
pip install --quiet glymur imagecodecs rasterio || \
  echo "   (skipped geo libs — fine for the EuroSAT RGB path)"
